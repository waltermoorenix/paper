...
graph LR
    ...
    C --> D[Recolha de informação por terceiros]
    D --> E[Assédio, controlo e cyberstalking]
    
    style A fill:#4b9de3,color:#fff,stroke:#fff
    style B fill:#5faee3,color:#fff,stroke:#fff
